...
const io = require('socket.io')(http, {path:"/api-camara-tamboril/socket.io" ,cors: { origins: ['*'] } });
...
app.use('/api-camara-tamboril/uploads', express.static('uploads'));
//app.use('/uploads', express.static('uploads'));

app.use('/api-camara-tamboril', router);
//app.use('/', cors(), router);
